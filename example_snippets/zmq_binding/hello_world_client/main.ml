(* Generated by mirage configure -t macosx (Mon, 5 Nov 2018 22:23:00 GMT). *)
...
let key1 = lazy (
  ...
  return (Functoria_runtime.with_argv (List.map fst Key_gen.runtime_keys) "hello_client" _argv_unix1)
  )
